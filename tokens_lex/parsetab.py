...
_lr_productions = [
  ...
  ('cad -> COMILLA NAME COMILLA','cad',3,'p_cad','sintactico.py',106),
  ('cad -> COMILLAD NAME COMILLAD','cad',3,'p_cad','sintactico.py',107),
  ('cad -> cad LCORCHETE index RCORCHETE','cad',4,'p_cad','sintactico.py',108),
  ('index -> factor','index',1,'p_index','sintactico.py',118),
  ('index -> factor DPOINT factor','index',3,'p_index','sintactico.py',119),
  ('index -> factor DPOINT factor DPOINT factor','index',5,'p_index','sintactico.py',120),
  ('while -> WHILE LPAREN comparison RPAREN DPOINT sentencia','while',6,'p_while','sintactico.py',133),
  ('while -> WHILE comparison DPOINT sentencia','while',4,'p_while','sintactico.py',134),
  ('while -> WHILE LPAREN comparison comparisons RPAREN DPOINT sentencia','while',7,'p_while','sintactico.py',135),
  ('while -> WHILE comparison comparisons DPOINT sentencia','while',5,'p_while','sintactico.py',136),
  ('comparisons -> AND comparison','comparisons',2,'p_comparisons','sintactico.py',147),
  ('comparisons -> AND comparison comparisons','comparisons',3,'p_comparisons','sintactico.py',148),
  ('comparisons -> OR comparison','comparisons',2,'p_comparisons','sintactico.py',149),
  ('comparisons -> OR comparison comparisons','comparisons',3,'p_comparisons','sintactico.py',150),
  ('bool -> TRUE','bool',1,'p_bool','sintactico.py',157),
  ('bool -> FALSE','bool',1,'p_bool','sintactico.py',158),
  ('comparison -> comp DEQUALS comp','comparison',3,'p_comparison','sintactico.py',163),
  ('comparison -> comp DIFFERENT comp','comparison',3,'p_comparison','sintactico.py',164),
  ('comparison -> comp HIGHER comp','comparison',3,'p_comparison','sintactico.py',165),
  ('comparison -> comp LESS comp','comparison',3,'p_comparison','sintactico.py',166),
  ('comparison -> comp HIGHEREQ comp','comparison',3,'p_comparison','sintactico.py',167),
  ('comparison -> comp LESSEQ comp','comparison',3,'p_comparison','sintactico.py',168),
  ('comparison -> bool','comparison',1,'p_comparison','sintactico.py',169),
  ('comp -> expr','comp',1,'p_comp','sintactico.py',176),
  ('comp -> element','comp',1,'p_comp','sintactico.py',177),
  ('comp -> bool','comp',1,'p_comp','sintactico.py',178),
  ('for -> FOR NAME IN RANGE LPAREN r_value RPAREN DPOINT assign','for',9,'p_for','sintactico.py',182),
  ('for -> FOR NAME IN RANGE LPAREN r_values RPAREN DPOINT assign','for',9,'p_for','sintactico.py',183),
  ('for -> FOR NAME IN NAME DPOINT assign','for',6,'p_for','sintactico.py',184),
  ('r_values -> r_value COMMA r_value','r_values',3,'p_r_values','sintactico.py',191),
  ('r_values -> r_value COMMA r_value COMMA r_value','r_values',5,'p_r_values','sintactico.py',192),
  ('r_value -> factor','r_value',1,'p_r_value','sintactico.py',199),
  ('r_value -> LEN LPAREN NAME RPAREN','r_value',4,'p_r_value','sintactico.py',200),
  ('if -> IF LPAREN comparison RPAREN DPOINT sentencia','if',6,'p_if','sintactico.py',207),
  ('if -> IF LPAREN comparison comparisons RPAREN DPOINT sentencia','if',7,'p_if','sintactico.py',208),
  ('if -> IF comparison DPOINT sentencia','if',4,'p_if','sintactico.py',209),
  ('if -> IF comparison comparisons DPOINT sentencia','if',5,'p_if','sintactico.py',210),
  ('if -> IF LPAREN comparison RPAREN DPOINT sentencia ELSE DPOINT sentencia','if',9,'p_if','sintactico.py',211),
  ('if -> IF LPAREN comparison comparisons RPAREN DPOINT sentencia ELSE DPOINT sentencia','if',10,'p_if','sintactico.py',212),
  ('if -> IF comparison DPOINT sentencia ELSE DPOINT sentencia','if',7,'p_if','sintactico.py',213),
  ('if -> IF comparison comparisons DPOINT sentencia ELSE DPOINT sentencia','if',8,'p_if','sintactico.py',214),
  ('if -> IF LPAREN comparison RPAREN DPOINT sentencia ELIF LPAREN comparison RPAREN DPOINT sentencia ELSE DPOINT sentencia','if',15,'p_if','sintactico.py',215),
  ('if -> IF LPAREN comparison comparisons RPAREN DPOINT sentencia ELIF LPAREN comparison comparisons RPAREN DPOINT sentencia ELSE DPOINT sentencia','if',17,'p_if','sintactico.py',216),
  ('if -> IF comparison DPOINT sentencia ELIF comparison DPOINT sentencia ELSE DPOINT sentencia','if',11,'p_if','sintactico.py',217),
  ('if -> IF comparison comparisons DPOINT sentencia ELIF comparison comparisons DPOINT sentencia ELSE DPOINT sentencia','if',13,'p_if','sintactico.py',218),
  ('if -> IF LPAREN comparison RPAREN DPOINT sentencia ELIF LPAREN comparison RPAREN DPOINT sentencia','if',12,'p_if','sintactico.py',219),
  ('if -> IF LPAREN comparison comparisons RPAREN DPOINT sentencia ELIF LPAREN comparison comparisons RPAREN DPOINT sentencia','if',14,'p_if','sintactico.py',220),
  ('if -> IF comparison DPOINT sentencia ELIF comparison DPOINT sentencia','if',8,'p_if','sintactico.py',221),
  ('if -> IF comparison comparisons DPOINT sentencia ELIF comparison comparisons DPOINT sentencia','if',10,'p_if','sintactico.py',222),
]
